...
dni.addEventListener('blur', ()=>{validarNumeros(dni)});
sexo.addEventListener('blur', ()=>{validarCampoRequerido(sexo)});
peso.addEventListener('blur', ()=>{validarNumeros(peso)});
altura.addEventListener('blur', ()=>{validarNumeros(altura)});
anioNacimiento.addEventListener('blur', ()=>{validarNumeros(anioNacimiento)});
